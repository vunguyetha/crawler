...
public class LinkedinService {
    public List<JobInfo> startCrawlingFromLinkedIn(String keywords) {
        try {
            ...
            String url = "https://www.linkedin.com/jobs/search/?currentJobId=3903663421&geoId=90010186&keywords=" +
                    keywords +
                    "&location=Hanoi%20Capital%20Region&origin=JOB_SEARCH_PAGE_LOCATION_AUTOCOMPLETE&refresh=true";
            ...
            for (Element item : li) {
                ...
                Element anchorTag = doc
                        .selectFirst("div.base-search-card__info > h4.base-search-card__subtitle > a");
